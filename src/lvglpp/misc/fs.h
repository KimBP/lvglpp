...
namespace lvgl::misc {
     ...
     */
    class FileSystem : public PointerWrapper<lv_fs_drv_t, free> {
    protected:
     ...
     */
    class File : public PointerWrapper<lv_fs_file_t, free> {
    public:
     ...
     */
    class Directory : public PointerWrapper<lv_fs_dir_t, free> {
    public:
        using PointerWrapper::PointerWrapper;
