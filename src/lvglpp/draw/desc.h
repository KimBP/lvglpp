...
namespace lvgl::draw {
     ...
     */
    class RectangleDrawDescriptor : public PointerWrapper<lv_draw_rect_dsc_t, free> {
    public:
     ...
     */
    class LabelDrawDescriptor : public PointerWrapper<lv_draw_label_dsc_t, free> {
    public:
     ...
     */
    class ImageDrawDescriptor : public PointerWrapper<lv_draw_img_dsc_t, free> {
    public:
        ImageDrawDescriptor();
     ...
     */
    class LineDrawDescriptor : public PointerWrapper<lv_draw_line_dsc_t, free> {
    public:
     ...
     */
    class ArcDrawDescriptor : public PointerWrapper<lv_draw_arc_dsc_t, free> {
    public:
